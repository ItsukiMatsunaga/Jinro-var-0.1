        ...
        ZStack{
            ...
            VStack{
                Text("最後の議論")
                    ...
                    .cornerRadius(20.0)
                Spacer()
                Text("それでは最後の議論を始めます。夜のアクションを踏まえて議論を行なってください。この議論終了後に追放投票を行います。")
                    .font(.system(size: 25))
            ...
            NavigationLink(destination:Discussion02(p1:p1,p2:p2,p3:p3,p4:p4,job_rule: job_rule,control:control),isActive:$next){
            EmptyView()
            }
...
struct voting_rule_Previews: PreviewProvider {
    static var previews: some View {
        voting_rule(p1: Control.P1(),p2: Control.P2(),p3: Control.P3(),p4: Control.P4(),job_rule: Control.Job_rule(),control: Control())
    }
}
