...
//  Jinro ver.01
//
//  Created by k19100kk on 2020/11/03.
//
                ...
                Spacer()
                    ...
                    Text("FINISH")
                        ...
                        if control.GironCnt == 0{
                            NavigationLink(destination:Night_rule(p1:p1,p2:p2,p3:p3,p4:p4,job_rule:job_rule,control: control),isActive: $isActiveSubView) {
                            }
                        }
                    }
                Spacer()
...
struct Discussion_Previews: PreviewProvider {
    static var previews: some View {
        Discussion(p1: Control.P1(),p2: Control.P2(),p3: Control.P3(),p4: Control.P4(),job_rule: Control.Job_rule(),control: Control())
    }
}
